document.addEventListener('DOMContentLoaded', () => {
    ...
    async function populateTopicTable(topicId) {
        ...
        try {
            ...
            // Filter for Geometry topics
            const topicData = data.filter(item =>
                item.tags.includes('Geometry') &&
    ...
    populateTopicTable('angle-names-table-body');
    populateTopicTable('special-right-triangles-table-body');
    populateTopicTable('intro-trig-functions-table-body');
    populateTopicTable('using-trig-functions-table-body');
