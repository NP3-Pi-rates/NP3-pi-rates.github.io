document.addEventListener('DOMContentLoaded', () => {
    ...
    async function populateTopicTable(topicId) {
        ...
        try {
            ...
            // Filter for Algebra 2 topics
            const topicData = data.filter(item =>
                item.tags.includes('Algebra 2') &&
    ...
    populateTopicTable('discriminant-table-body');
    populateTopicTable('domain-range-table-body');
    populateTopicTable('synthetic-division-table-body');
    populateTopicTable('exponential-functions-table-body');
    populateTopicTable('radical-functions-table-body');
    populateTopicTable('absolute-value-table-body');
    populateTopicTable('polynomial-functions-table-body');
    populateTopicTable('rational-expressions-table-body');
